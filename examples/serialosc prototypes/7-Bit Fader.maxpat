...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 25.0, 163.0, 179.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 25.0, 117.0, 163.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "int", "", "" ],
					"patching_rect" : [ 25.0, 201.0, 201.0, 24.0 ],
					"varname" : "serialosc[2]",
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 216.800003230571747, 410.400006115436554, 72.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 35.200000524520874, 52.000000774860382, 79.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 216.800003230571747, 320.800004780292511, 33.0, 23.0 ],
									"rnbo_classname" : "*",
									"rnbo_extra_attributes" : 									{
										"hot" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 216.800003230571747, 361.600005388259888, 67.0, 23.0 ],
									"rnbo_classname" : "list.group",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "list.group_obj-71",
									"text" : "list.group 8"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 216.800003230571747, 274.400004088878632, 65.0, 23.0 ],
									"rnbo_classname" : "peek",
									"rnbo_extra_attributes" : 									{
										"channelmode" : "ignore",
										"channels" : 1.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 216.800003230571747, 233.600003480911255, 49.166643679141998, 23.0 ],
									"rnbo_classname" : "+",
									"rnbo_extra_attributes" : 									{
										"hot" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 247.200003683567047, 180.000002682209015, 29.5, 23.0 ],
									"rnbo_classname" : "*",
									"rnbo_extra_attributes" : 									{
										"hot" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 192.000002861022949, 140.000002086162567, 74.166643679141998, 23.0 ],
									"rnbo_classname" : "t",
									"rnbo_extra_attributes" : 									{
										"triggers" : ""
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 192.000002861022949, 180.000002682209015, 44.0, 23.0 ],
									"rnbo_classname" : "uzi",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "uzi_obj-64",
									"text" : "uzi 8 0"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 192.000002861022949, 96.000001430511475, 50.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 192.000002861022949, 52.000000774860382, 174.0, 23.0 ],
...
,
									"text" : "param Input @min 0 @max 127",
									"varname" : "Input"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 568.800008475780487, 434.400006473064423, 108.0, 35.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 216.800003230571747, 456.800006806850433, 183.0, 23.0 ],
...
,
					"patching_rect" : [ 25.0, 67.0, 129.0, 22.0 ],
					"rnboattrcache" : 					{
						"Input" : 						{
							"label" : "Input",
							"isEnum" : 0,
...
,
									"fileref" : 									{
										"name" : "7BitFader",
										"filename" : "7BitFader.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "a31d61e8f1df18745142b6d3037b5697"
									}
